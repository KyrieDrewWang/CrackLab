...
from __train_history__.config_swinupercrack import Config as cfg
...
class ModelTrainer(nn.Module, Trainer):
    ...
    def train_op(self, input, target):
        ...
        pred_output, pred_fuse4, pred_fuse3, pred_fuse2, pred_fuse1 = self.model(input)
        ...
        total_loss = output_loss*cfg.output_loss_weight + fuse4_loss*cfg.fuse4_loss_weight + fuse3_loss*cfg.fuse3_loss_weight + fuse2_loss*cfg.fuse2_loss_weight + fuse1_loss*cfg.fuse1_loss_weight
        total_loss.backward()
        self.optimizer.step()
        self.log_loss = {
        ...
        return pred_output, pred_fuse4, pred_fuse3, pred_fuse2, pred_fuse1
